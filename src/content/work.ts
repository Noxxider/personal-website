...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "The front page is seven pinned chapters driven by Lenis and GSAP ScrollTrigger, with one WebGL canvas behind them: a textured Earth that turns and zooms to Canada, a week of bookings rising as bars, an N-body simulation, screenshot cards, and the two social marks. Everything is prerendered to HTML, the 3D is a lazy chunk behind a poster, and reduced motion collapses the whole thing to a plain page.",
    year: "2026",
    status: "Live",
